...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_CTL_Z] = ACTION_TAP_DANCE_DOUBLE(KC_A,LCTL(KC_Z)),
    [TD_CTL_X] = ACTION_TAP_DANCE_DOUBLE(KC_A,LCTL(KC_X)),
    [TD_CTL_C] = ACTION_TAP_DANCE_DOUBLE(KC_A,LCTL(KC_C)),
    [TD_CTL_V] = ACTION_TAP_DANCE_DOUBLE(KC_A,LCTL(KC_V)),
    
    [TD_MINUS_TO_UNDUNDER] = ACTION_TAP_DANCE_DOUBLE(KC_MINUS,S(KC_INT1)),
    [TD_ENT_TO_Y] = ACTION_TAP_DANCE_DOUBLE(KC_ENT,KC_Y),
    [TD_BS_TO_N] = ACTION_TAP_DANCE_DOUBLE(KC_BSPC,KC_N),
